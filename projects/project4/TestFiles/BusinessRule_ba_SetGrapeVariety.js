...
{
  "id" : "ba_SetGrapeVariety",
  "type" : "BusinessAction",
  "setupGroups" : [ "brg_SetValuesAndLinkes" ],
  "name" : "Set Grape Variety",
  "description" : null,
  "scope" : "Global",
...
*/
exports.operation0 = function (node,manager,ref_GrapeSpeciesCultivar,att_GrapeVariety,lov_GrapeVariety,att_COSMOSNumberCounter,GrapeSpeciesCultivar,att_ProductType,ErrorMessage,ErrorMessageSequence) {
/*
...
query.forEach(function (nodetest) {
  var nodeValue = nodetest.getValue();
  if (nodeValue && nodeValue.equals(concatinatedTargets)) {
    lovExists = true;
    return false;
  }
  return true;
...
//	node.getWorkflowInstance(workflow).setSimpleVariable("NewGrapeVariety", "YES");
}
}