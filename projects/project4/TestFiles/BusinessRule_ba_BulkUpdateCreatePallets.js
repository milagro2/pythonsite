...
{
  "id" : "ba_BulkUpdateCreatePallets",
  "type" : "BusinessAction",
  "setupGroups" : [ "brg_Actions" ],
  "name" : "Bulk Update - Create Empty Pallets",
  "description" : null,
  "scope" : "Global",
...
/*===== business rule plugin definition =====
{
  ...
  "binds" : [ {
    ...
    "alias" : "att_PalletGTIN",
    "parameterClass" : "com.stibo.core.domain.impl.AttributeImpl",
    "value" : "att_PalletGTIN",
    "description" : null
  }, {
  ...
  "messages" : [ {
    ...
    "message" : "The GTIN is already in use in the following {article} {name}. Please select a different GTIN number. ",
    "translations" : [ {
      "language" : "nl",
      "message" : "Het EAN-nummer is al in gebruik in het volgende {article} {name}. Selecteer een ander EAN-nummer."
    } ]
  } ],
  "pluginType" : "Operation"
}
*/
exports.operation0 = function (node,manager,att_PalletGTIN,prd_PackagingUnitPallet,att_PalletName,att_GlobalTradeIdentificationNumber,ba_CreateNewGTIN,prd_PackagingUnitPack,prd_PackagingUnitEach,prd_PackagingUnitCase,att_QuantityOfNextLowerLevel,ref_GlobalTradeIdentificationNumbers,ref_NextLowerLevel,lov_PackagingUnitID,ErrorDuplicate) {
