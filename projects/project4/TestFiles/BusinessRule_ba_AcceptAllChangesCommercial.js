...
{
  "id" : "ba_AcceptAllChangesCommercial",
  "type" : "BusinessAction",
  "setupGroups" : [ "brg_ArticleMaintenanceActions" ],
  "name" : "Accept All Changes Commercial (Web UI)",
  "description" : null,
  "scope" : "Global",
  "validObjectTypes" : [ ],
...
for(var i = 0; i < selectedNodes.size(); i++) {
	...
	if(commercialTask) {
		var trigger = commercialTask.triggerByID("Accept_All_Changes", "All changes accepted from Web UI");
