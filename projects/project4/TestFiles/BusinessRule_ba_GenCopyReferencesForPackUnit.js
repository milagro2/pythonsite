...
{
  "id" : "ba_GenCopyReferencesForPackUnit",
  "type" : "BusinessAction",
...
*/
exports.operation0 = function (node,atg_TIIPack_AlwaysOverwrite,bf_GetReferencesFromGroup,ptp_PartnerArticle,manager) {
...
node.queryReferences(ptp_PartnerArticle).forEach(function (tradeItemLink) {
	...
	for (var i=0; i < attributeGroups.size(); i++) {
		...
		var references = bf_GetReferencesFromGroup.evaluate({attributeGroup: atg_TIIPack_AlwaysOverwrite});
